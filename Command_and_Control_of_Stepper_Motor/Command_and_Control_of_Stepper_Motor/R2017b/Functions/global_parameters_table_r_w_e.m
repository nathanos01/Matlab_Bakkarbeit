function [global_params] = global_parameters_table_r_w_e()
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function: global_parameters_table_r_w_e()
% Goal    : Output a structure that contains all the available global
...
% IN      : -
% IN/OUT  : -
% OUT     : - global_params: list of all read global parameters for the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  global_params = struct(...
                  ...
                  'TMCL_APPLICATION_STATUS'        ,{128,MAX_0b, MAX_2b},...
                  'DOWNLOAD_MODE'                  ,{129,MAX_0b, MAX_1b},...
                  'TMCL_PROGRAM_COUNTER'           ,{130,MAX_0b,MAX_32b},...
